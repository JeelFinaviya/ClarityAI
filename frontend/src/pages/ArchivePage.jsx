      ...
      <div className="w-full flex-1 flex flex-col items-center justify-start arena-bg-radial px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="w-full max-w-5xl mb-4">
          <button
            ...
            className="px-4 py-2 rounded-xl bg-[#121520] hover:bg-[#181c2b] text-slate-200 text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer"
          >
    ...
    <div className="w-full flex-1 flex flex-col items-center justify-start arena-bg-radial px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="w-full max-w-5xl flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#3b82f6]/10 border border-[#3b82f6]/20 text-[#60a5fa] text-xs font-semibold mb-2">
          ...
          <button
            type="button"
            onClick={onStartNew}
            className="px-6 py-3 rounded-xl bg-[#3b82f6] hover:bg-[#2563eb] text-white font-display text-xs font-bold shadow-md hover:scale-105 active:scale-95 transition-all flex items-center gap-2 cursor-pointer"
          >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-[#090a0f] border border-white/10 text-white placeholder-slate-500 text-xs font-medium focus:border-[#3b82f6] focus:outline-none transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            <select
              ...
              className="px-3 py-2 rounded-xl bg-[#090a0f] border border-white/10 text-slate-300 text-xs font-medium focus:outline-none cursor-pointer"
            >
        ...
        {isLoading ? (
          ...
          <div className="glass-card rounded-2xl p-12 text-center flex flex-col items-center gap-4">
            ...
            <button
              type="button"
              onClick={onStartNew}
              className="px-5 py-2.5 rounded-xl bg-[#3b82f6] text-white text-xs font-bold shadow-md hover:bg-[#2563eb] transition-all cursor-pointer"
            >
              ...
              return (
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold font-mono-code ${
                        ...
                        score >= 60 ? 'bg-[#3b82f6]/10 text-[#60a5fa] border border-[#3b82f6]/20' :
                        score >= 45 ? 'bg-amber-500/10 text-amber-400 border border-amber-500/20' : 'bg-rose-500/10 text-rose-400 border border-rose-500/20'
                      }`}>
                        {score}% Score
                      </span>
                    ...
                    <h3 
                      ...
                      className="font-display text-base font-bold text-white group-hover:text-blue-200 transition-colors cursor-pointer mb-1 line-clamp-1"
                    >
                      {rec.topic}
                    </h3>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-white/5 text-xs">
                    <span className="text-slate-500 text-[11px] font-mono-code">{dateStr}</span>
                    <button
                      type="button"
                      onClick={() => handleOpenDetail(rec.id)}
                      className="text-[#3b82f6] hover:text-blue-400 font-semibold flex items-center gap-1 cursor-pointer"
                    >
            ...
            <div className="glass-card rounded-2xl p-6 max-w-sm w-full border border-white/10 shadow-2xl flex flex-col gap-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-[#121520] hover:bg-[#181c2b] text-slate-300 text-xs font-semibold cursor-pointer"
                >
                  Cancel
                </button>
                <button
