      ...
      <div className="w-full max-w-5xl flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
          ...
          <button
            type="button"
            onClick={onStartNew}
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-cyan-500 text-white font-display text-xs font-bold shadow-lg shadow-indigo-500/30 hover:scale-105 active:scale-95 transition-all flex items-center gap-2 cursor-pointer"
          >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900/80 border border-white/10 text-white placeholder-slate-500 text-xs font-medium focus:border-indigo-500 focus:outline-none transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            <select
              ...
              className="px-3 py-2 rounded-xl bg-slate-900/80 border border-white/10 text-slate-300 text-xs font-medium focus:outline-none cursor-pointer"
            >
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold font-mono-code ${
                        ...
                        score >= 45 ? 'bg-amber-500/20 text-amber-300' : 'bg-rose-500/20 text-rose-300'
                      }`}>
                        {score}% Score
                      </span>
                    ...
                    <h3 
                      ...
                      className="font-display text-base font-bold text-white group-hover:text-cyan-300 transition-colors cursor-pointer mb-1 line-clamp-1"
                    >
                      {rec.topic}
                    </h3>
