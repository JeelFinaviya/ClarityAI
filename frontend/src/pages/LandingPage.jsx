...
export function LandingPage({ onStart, onSelectTopic, onNavigateInterviewLab }) {
  ...
  return (
    <div className="w-full flex-1 flex flex-col items-center justify-start arena-bg-radial px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-7xl mx-auto">
      
      {/* Hero Badge */}
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#3b82f6]/10 border border-[#3b82f6]/25 text-[#60a5fa] text-xs font-semibold mb-5 shadow-sm">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 items-stretch">
        
        {/* Pillar 1: Concept Explorer */}
        <div className="bg-[#121520] rounded-2xl p-6 sm:p-7 border border-white/10 shadow-xl flex flex-col justify-between group hover:border-[#3b82f6]/50 transition-all h-full">
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[11px] font-mono-code font-semibold px-3 py-1 rounded-md bg-[#3b82f6]/15 text-[#60a5fa] border border-[#3b82f6]/30">
                Interactive Diagnostic
              </span>
            </div>

            <h2 className="font-display text-xl sm:text-2xl font-bold text-white mb-2 flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={onStart}
            className="w-full py-3.5 px-5 rounded-xl bg-[#3b82f6] hover:bg-[#2563eb] text-white font-semibold text-sm shadow-lg shadow-blue-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer group/btn active:scale-[0.99] mt-auto"
          >
        ...
        <div className="bg-[#121520] rounded-2xl p-6 sm:p-7 border border-white/10 shadow-xl flex flex-col justify-between group hover:border-emerald-500/50 transition-all h-full">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="w-10 h-10 rounded-xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-400">
                <BookOpen className="w-5 h-5" />
              </div>
              <span className="text-[11px] font-mono-code font-semibold px-3 py-1 rounded-md bg-emerald-500/15 text-emerald-400 border border-emerald-500/30">
          ...
          <button
            ...
            className="w-full py-3.5 px-5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-semibold text-sm shadow-lg shadow-emerald-600/20 transition-all flex items-center justify-center gap-2 cursor-pointer group/btn active:scale-[0.99] mt-auto"
          >
          ...
          {popularTopics.map((topicItem) => {
            ...
            return (
              <div
                ...
                className="bg-[#121520] rounded-xl p-5 border border-white/10 hover:border-[#3b82f6]/40 cursor-pointer flex flex-col justify-between group transition-all hover:bg-[#161a29]"
              >
                <div>
      ...
      <div className="w-full max-w-5xl mb-12">
        <div className="text-center mb-6">
          <h2 className="font-display text-xl sm:text-2xl font-bold text-white mb-1.5">
      ...
      <div className="w-full max-w-5xl bg-[#121520] rounded-2xl p-6 sm:p-7 border border-white/10 mb-8">
